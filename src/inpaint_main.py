...
tf.flags.DEFINE_float('lamb', 0.3, 'hyper-parameter for prior loss, default: 0.3')  # lambda is 0.003 in the paper
...
tf.flags.DEFINE_integer('num_try', 10, 'number of randome samples, default: 10')
